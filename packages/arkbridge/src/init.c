...
static const R_CallMethodDef CallEntries[] = {
  {"C_ark_member_names", (DL_FUNC) &C_ark_member_names, 2},
  {"C_ark_ipc_start", (DL_FUNC) &C_ark_ipc_start, 2},
  {"C_ark_ipc_config", (DL_FUNC) &C_ark_ipc_config, 2},
  {"C_ark_ipc_stop", (DL_FUNC) &C_ark_ipc_stop, 0},
  {"C_ark_ipc_status", (DL_FUNC) &C_ark_ipc_status, 0},
  {NULL, NULL, 0}
};
