...
local console_ansi = require("ark.console_ansi")
local console_transcript = require("ark.console_transcript")

local M = {}

local line_spans = console_transcript.line_spans
local line_text = console_transcript.line_text
local strip_prompt_suffix = console_transcript.strip_prompt_suffix
local styled_chunks = console_transcript.styled_chunks
local submitted_output_group = console_transcript.submitted_output_group
local transcript_lines_from_output = console_transcript.lines_from_output
...
local consume_terminal_output = console_ansi.new({
  palette_color = ansi_color,
  style_group = ansi_style_group,
})
local truncate_spans = console_ansi.truncate_spans
