...
local function launcher_env(config, session_id)
  local env = {
    ...
    ARK_NVIM_PARENT_NVIM = vim.v.progpath or "nvim",
    ARK_NVIM_PARENT_SERVER = session_runtime.parent_server(config),
...
local function pane_command_exports(config, session_id)
  local exports = {
    ...
    "ARK_NVIM_MANAGED_PANE=1",
    "ARK_NVIM_PARENT_NVIM=" .. shellescape(vim.v.progpath or "nvim"),
    "ARK_NVIM_PARENT_SERVER=" .. shellescape(session_runtime.parent_server(config)),
